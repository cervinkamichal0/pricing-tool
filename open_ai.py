...
def suggest_description(ad_title):
    ...
    chat_completion = client.chat.completions.create(
        messages=[
            {
                "role": "system", 
                "content":  "Vytvoř strukturu popisu pro věc, kterou chci prodat na inzertním webu."
                            ...
                            "Popisuj věc jako její průměrný uživatel. Nepiš tedy například příliš odborně. Uváděj tedy pouze strukturu pro informace o jejím stavu."
                            "Popis inzerátu by měl být optimální pro použití se sentence_transformers pro porovnání podobnosti s ostatními inzeráty."
                            "Nijak popis nestyluj. (nepoužívej markdown, pouze vrať text)."
